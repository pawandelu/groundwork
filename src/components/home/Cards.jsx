...
const Cards = () => {
  ...
  return (
    <section className="px-3 pt-10 sm:pt-15 md:pt-20 lg:pt-25 relative">
      <img
        src="/assets/image/webp/card-bg-img.webp"
        className=" absolute -top-2.5 right-0"
        alt="card-bg"
      />
      <img
        src="/assets/image/webp/card-right-img.webp"
        className=" absolute top-0 max-sm:hidden right-5 lg:right-37 w-[54.42px] h-50"
        alt="hook"
      />
      ...
      <div className="max-w-285 w-full mx-auto overflow-hidden flex flex-col">
        ...
        <div className=" relative flex flex-col md:flex-row mt-10 lg:mt-[49.5px]">
          ...
          <div className="md:max-w-108 w-full md:h-72">
            <img
              src={CARD_DATA[active].bottomImage}
              alt="bottom-img"
