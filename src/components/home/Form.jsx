      ...
      <div className="max-w-293 w-full mx-auto flex flex-col items-center justify-center px-4">
        ...
        <div className="w-full sm:p-8 p-4 bg-orange rounded-[10px] border-none lg:mt-15 md:mt-12 sm:mt-8 mt-6">
          ...
          <form className="mt-6">
            ...
            <button
              type="submit"
              className="bg-dark-black text-white group hover:bg-white hover:text-dark-black sm:px-6 sm:py-4 px-3 py-2 rounded-md flex items-center font-semibold sm:text-[18px] text-[14px] leading-[100%] sm:gap-4 gap-2 mt-5.5  transition-all duration-500 cursor-pointer"
            >
              Send Message
              <Icon
                icon={"arrowright"}
